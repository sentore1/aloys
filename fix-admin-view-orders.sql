...
TO authenticated
USING (
  auth.email() = 'Itechfurniture@gmail.com' 
  OR auth.email() = 'Itechfurniteure@gmail.com'
  OR auth.email() = 'Itechfu43rniture@gmail.com'
  OR auth.email() = 'Itechrwfurniture@gmail.com'
);
