# 📋 Itech SEO - QUICK REFERENCE CARD
...
VALUES (
  ...
  '[image-url]',
  [Stock],
  '[Product Name] - [Type] | Itech',
  'Shop [Product] at Itech. [Features]. [Material]. [CTA].',
...
- [ ] Include "Itech [category]" in keywords
...
**With Material:**
`[Material] [Product] - Luxury [Category] | Itech`

**With Style:**
`[Style] [Product] - Designer [Category] | Itech`

**Examples:**
- Silk Evening Gown - Luxury Designer Dress | Itech
- Cashmere Turtleneck - Premium Knitwear | Itech
...
```
Shop [Product] at Itech. [Key Feature 1]. [Key Feature 2]. [CTA].
```
