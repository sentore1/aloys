// SEO Content Generator for Itech Products
...
const brandKeywords = [
  'Itech', 'Itech fashion', 'Itech clothing', 'Itech luxury'
]
...
function generateSEO(productName, category, price) {
  ...
  // Generate SEO Title
  const seoTitle = `${productName} - Luxury ${category.charAt(0).toUpperCase() + category.slice(1)} | Itech`
  
  // Generate SEO Description
  const seoDescription = `Shop ${productName} at Itech. Premium quality ${category} crafted for discerning fashion enthusiasts. Luxury designer wear with sophisticated style. Free shipping on orders over $100.`
...
console.log('=== Itech SEO Generator ===\n')
